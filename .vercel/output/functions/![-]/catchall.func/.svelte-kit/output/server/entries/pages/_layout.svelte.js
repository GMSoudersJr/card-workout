import { c as create_ssr_component, g as get_store_value, o as onDestroy, a as add_styles, e as escape, v as validate_component, m as missing_component, b as spread, d as escape_object, f as merge_ssr_styles, h as add_attribute, i as subscribe, j as each } from "../../chunks/ssr.js";
...
const Navigation = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  onNavigate((navigation) => {
    if (document.startViewTransition === void 0 || document.startViewTransition === null)
      return;
...
const css = {
  code: "main.svelte-pcadot{width:100vw;height:100svh}",
  map: null
};
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$result.css.add(css);
  $$unsubscribe_page();
  return `${$$result.head += `<!-- HEAD_svelte-kpxqsm_START -->${$$result.title = `<title> ${escape($page.data.title)} </title>`, ""}<meta name="description"${add_attribute("content", `${$page.data.description}`, 0)}><meta property="og:site_name" content="SUIT YOURSELF"><meta property="og:title"${add_attribute("content", `${$page.data.title}`, 0)}><meta property="og:type" content="website"><meta property="og:description"${add_attribute("content", `${$page.data.description}`, 0)}><meta property="og:url"${add_attribute("content", `${$page.url.href}`, 0)}><meta property="og:image"${add_attribute("content", `${$page.data.metaImageUrl}`, 0)}><meta property="og:img:alt" content="Screen capture of the home page"><meta property="twitter:card" content="summary_large_image"><meta property="twitter:title"${add_attribute("content", `${$page.data.title}`, 0)}><meta property="twitter:description"${add_attribute("content", `${$page.data.description}`, 0)}><meta property="twitter:image"${add_attribute("content", `${$page.data.title}`, 0)}><!-- HEAD_svelte-kpxqsm_END -->`, ""}  ${validate_component(Toaster, "Toaster").$$render($$result, {}, {}, {})} ${validate_component(Navigation, "ViewTransition").$$render($$result, {}, {}, {})} <main class="svelte-pcadot">${slots.default ? slots.default({}) : ``} </main>`;
});
export {
  Layout as default
};
