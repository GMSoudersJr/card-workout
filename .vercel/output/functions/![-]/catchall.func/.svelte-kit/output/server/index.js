    ...
    error_components = await Promise.all(
      ...
      branch.map((b, i) => {
        ...
        if (!b)
          return null;
        i--;
        while (i > last_idx + 1 && page.errors[i] === void 0)
          i -= 1;
        last_idx = i;
