...
badd +105 src/lib/components/cards/CardsInfoWidget.svelte
...
badd +21 src/lib/components/cards/RankInfoBox.svelte
badd +54 src/lib/components/cards/RepsProgressBox.svelte
badd +12 src/lib/components/cards/RepsInfoWidget.svelte
badd +37 src/lib/components/cards/SuitInfoWidget.svelte
badd +22 src/lib/components/cards/RankInfoWidget.svelte
badd +49 src/lib/components/cards/SuitInfoBox.svelte
argglobal
%argdel
$argadd ./
...
setlocal fen
silent! normal! zE
let s:l = 123 - ((25 * winheight(0) + 16) / 32)
...
setlocal fen
silent! normal! zE
let s:l = 45 - ((23 * winheight(0) + 15) / 31)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
45
...
wincmd w
argglobal
if bufexists("~/svelte_projects/card-workout/src/lib/components/cards/RankInfoBox.svelte") | buffer ~/svelte_projects/card-workout/src/lib/components/cards/RankInfoBox.svelte | else | edit ~/svelte_projects/card-workout/src/lib/components/cards/RankInfoBox.svelte | endif
setlocal fdm=manual
setlocal fde=0
setlocal fmr={{{,}}}
setlocal fdi=#
